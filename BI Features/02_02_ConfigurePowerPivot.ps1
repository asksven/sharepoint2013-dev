...
Write-Host "(VM) $(Get-Date): Start to configure powerpivot for Sharepoint 2013."

& "C:\Program Files\Microsoft SQL Server\110\Tools\PowerPivotTools\SPAddinConfiguration\Bin\PowerPivotSPAddinConfiguration.exe"
